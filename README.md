...
## Use in your KiCad project

Simply copy the [`JLCPCB.kicad_dru`](JLCPCB/JLCPCB.kicad_dru) file into your KiCad project folder, and rename it to match your project name `your-project.kicad_dru`.
